...
export const employeeSchema = z.object({
  ...
  // Department is required for employees and managers, but NOT for HR
...
export const skillSchema = z.object({
  ...
  auto_eval: z.coerce.number().min(0).max(5).optional().default(0),
  hierarchie_eval: z.coerce.number().min(0).max(5).optional().default(0),
});
